...
<table width="600" align="center" border=1>
	...
	<tr><td>*회원주소</td>
		<td>
			<input type="text" name="memberAddr" id="sample4_roadAddress" required="required" readonly="readonly"/>
	...
	<tr><td>*회원우편번호</td>
		<td>
			<input type="text" name="memberPost" id="sample4_postcode" required="required" readonly="readonly" />
		</td></tr>
	<tr><td>*회원이메일</td>
		<td>
			<input type="email" name="memberEmail" required="required" />
		</td></tr>
	<tr><td>*회원생년월일</td>
		<td>
